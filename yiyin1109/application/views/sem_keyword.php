...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">SEM关键词统计</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered">
						...
						<?php foreach($record_list as $k => $v): ?>
							...
							<tr>
								<?php if($dk == 0): ?>
								<td rowspan="<?php echo count($v['detail']); ?>"><?php echo $v['keyword']; ?></td>
								<?php endif; ?>
								<td><a href="<?php echo $dv['page']; ?>" target="_blank" ><?php echo str_replace(rtrim($site_url, '/'), '', $dv['page']); ?></a></td>
...
function search(){
	...
	location.href = admin.url+'sem/keyword/'+start+'/'+end+'/'+is_submit;
}
